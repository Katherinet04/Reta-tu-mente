...
<title>Nivel 2 - Pantalla 5</title>
...
<div id="juego">
    ...
    <div class="card">
        ...
        onclick="seleccionarImagen(this,'img37')">
    ...
    <div class="card">
        ...
        onclick="seleccionarImagen(this,'img38')">
    ...
    <div class="card">
        ...
        onclick="seleccionarImagen(this,'img39')">
    ...
    <div class="card">
        ...
        onclick="seleccionarImagen(this,'img40')">
...
const pistasNivel = [
    ...
    "Se usa en la cabeza para protegerse del sol o del frío.",

    " Puede tener diferentes formas, colores y adornos."
...
<script src="nivel2script.js"></script>
