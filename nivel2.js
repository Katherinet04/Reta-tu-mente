...
function actualizarProgreso(){
    ...
    switch(paginaActual){
        ...
        case "siguientenivel.php":
            porcentaje = 0;
            break;

        case "nivel2pantalla2.php":
            porcentaje = 25;
            break;

        case "nivel2pantalla3.php":
            porcentaje = 50;
            break;

        case "nivel2pantalla4.php":
            porcentaje = 75;
            break;
...
const respuestas = {
    ...
    'siguientenivel.php':'img22',

    'nivel2pantalla2.php':'img26',

    'nivel2pantalla3.php':'img32',

    'nivel2pantalla4.php':'img33'
