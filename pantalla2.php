...
<div id="juego">
    ...
    <div class="card">
        ...
        <img
        src="images/img5.jpg"
        onclick="seleccionarImagen(this,'img5')">
    ...
    <div class="card">
        ...
        <img
        src="images/img6.png"
        onclick="seleccionarImagen(this,'img6')">
    ...
    <div class="card">
        ...
        <img
        src="images/img7.png"
        onclick="seleccionarImagen(this,'img7')">
    ...
    <div class="card">
        ...
        <img
        src="images/img8.png"
        onclick="seleccionarImagen(this,'img8')">
...
const pistasNivel = [
    ...
    " Este objeto ayuda a saber qué hora es.",
